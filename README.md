...
In this exercise, you will make it possible for the ship to shoot bullets. You will also create asteroids and set them in motion (in a random direction). You will also be introducted to using `move_and_slide` for movement, instead of updating the position directly.

The expectations for this exercise are that you will

 - [ ] Fork and clone this repository
 - [ ] Import the project into Godot
 - [ ] Create a Bullet scene: set up the bullet's appearance and behavior, including collisions
 - [ ] Create an Asteroid scene
...
Fork the repository. When that process has completed, make sure that the top of the repository reads `[your username]/Exercise-02b-Bullets-and-Asteroids`. *Edit the LICENSE and replace BL-MSCH-C220 with your full name.* Commit your changes.
